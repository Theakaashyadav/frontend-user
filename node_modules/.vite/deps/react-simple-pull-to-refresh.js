...
// node_modules/react-simple-pull-to-refresh/build/index.esm.js
...
var PullingContent = function() {
  return import_react.default.createElement(
    "div",
    null,
    import_react.default.createElement("p", null, "↧  pull to refresh  ↧")
  );
};
...
var PullToRefresh = function(_a) {
  var _b = _a.isPullable, isPullable = _b === void 0 ? true : _b, _c = _a.canFetchMore, canFetchMore = _c === void 0 ? false : _c, onRefresh = _a.onRefresh, onFetchMore = _a.onFetchMore, _d = _a.refreshingContent, refreshingContent = _d === void 0 ? import_react.default.createElement(RefreshingContent, null) : _d, _e = _a.pullingContent, pullingContent = _e === void 0 ? import_react.default.createElement(PullingContent, null) : _e, children = _a.children, _f = _a.pullDownThreshold, pullDownThreshold = _f === void 0 ? 67 : _f, _g = _a.fetchMoreThreshold, fetchMoreThreshold = _g === void 0 ? 100 : _g, _h = _a.maxPullDownDistance, maxPullDownDistance = _h === void 0 ? 95 : _h, _j = _a.resistance, resistance = _j === void 0 ? 1 : _j, backgroundColor = _a.backgroundColor, _k = _a.className, className = _k === void 0 ? "" : _k;
  ...
  (0, import_react.useEffect)(function() {
    var _a2;
    if (!((_a2 = containerRef) === null || _a2 === void 0 ? void 0 : _a2.current))
      return;
  ...
  var getScrollToBottomValue = function() {
    ...
    var scrollHeight = childrenRef.current.scrollHeight;
  ...
  return import_react.default.createElement(
    "div",
    { className: "ptr " + className, style: { backgroundColor }, ref: containerRef },
    import_react.default.createElement(
      "div",
      { className: "ptr__pull-down", ref: pullDownRef },
      import_react.default.createElement("div", { className: "ptr__loader ptr__pull-down--loading" }, refreshingContent),
      import_react.default.createElement("div", { className: "ptr__pull-down--pull-more" }, pullingContent)
    ),
    import_react.default.createElement(
      "div",
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement("div", { className: "ptr__loader ptr__fetch-more--loading" }, refreshingContent)
      )
    )
  );
};
var index_esm_default = PullToRefresh;
export {
  index_esm_default as default
};
//# sourceMappingURL=react-simple-pull-to-refresh.js.map
